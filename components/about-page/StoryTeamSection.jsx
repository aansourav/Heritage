...
import ha1 from "../../public/assets/images/a-h1.jpeg";
import rHouse from "../../public/assets/images/about-home.jpeg";
import ha2 from "../../public/assets/images/ah2.jpeg";
import man1 from "../../public/assets/images/sm1.jpeg";
import man2 from "../../public/assets/images/sm2.jpeg";
import man3 from "../../public/assets/images/sm3.jpeg";

const StoryTeamSection = () => {
    return (
        <>
                ...
                <div>
                    ...
                    <div className=" flex items-center justify-end">
                        <div className="bg-[#ECF5FF] px-8 py-8 text-start w-7/12 relative -mt-36">
                            ...
                            <p className=" mt-6">
                                In the symphony of bustling markets and serene
                                landscapes, Heritage-Nest was born—a vision to
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className=" mt-20 w-10/12 mx-auto">
                <div>
                    <div className=" flex items-end justify-end mr-10">
                        <Image className=" w-9/12 h-[455px]" src={ha2} alt="" />
                    </div>
                    <div className=" flex items-center justify-start">
                        <div className="bg-[#FDF0E7] px-8 py-8 text-start w-7/12 relative -mt-28">
                            ...
                            <p className=" mt-6 text-gray-500">
                                To bridge the miles with smiles, Heritage-Nest
                                pledges to be the golden thread connecting NRIs
                                to their homeland, through trust, transparency,
                                and tailored real estate solutions.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className=" text-gray-500 mt-6">
                                each member an embodiment of expertise and
                                warmth, dedicated to guiding you home, every
                                step of the way.
                            </p>
                            <div className=" mt-12">
